...
You will be working from the Human Assembly **Dec. 2013 (GRCh38/hg38)**. Make sure this is selected under the "Find Position" dropdown menu. Enter **HOXA7** in Position/Search Term and select GO. 
...
Under "Visible Tracks", select "Hide" under all the drop downs _except_ "NCBI RefSeq". Set this one to "Full".
