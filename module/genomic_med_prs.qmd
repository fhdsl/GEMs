...
## Student Activity - Questions Only

-   [Web page](https://genomicseducation.org/module/genomic_med_prs_questions_only.html)
-   [Quarto (qmd)](https://github.com/fhdsl/GEMs/blob/main/module/genomic_med_prs_questions_only.qmd)
-   [Word (docx)](https://github.com/fhdsl/GEMs/raw/main/docs/docx/module/genomic_med_prs_questions_only.docx)
-   [Google Doc](https://docs.google.com/document/d/1wlKYgCkkPW_hTLe3B1-sxbWOxWaQV6pu/edit?usp=sharing&ouid=116032995747974603894&rtpof=true&sd=true)
...
Link: <https://prs.byu.edu/calculate_score.html>.
:::
...
You might want to swap out some of the datasets used. Here are some additional individuals with prostate cancer markers that are appropriate for the _Conti_ and _Eeles_ studies:

- <https://genomicseducation.org/data/prs_ind_3.txt>  
- <https://genomicseducation.org/data/prs_ind_4.txt>  
- <https://genomicseducation.org/data/prs_ind_5.txt>  

You can also generate your own! Just change a few of the alleles.

To create an activity around a different condition, we recommend the following steps:

- Identify a study of interest. For example, you might look at a study on addiction like GCST001880.  
- Looks this study up on <https://www.ebi.ac.uk/gwas/home> to see the risk alleles. 
- Start creating some test results! For example, we can see that rs2377339-G is a risk allele. We might want to include that in the panel.  
- Try to include some non-risk alleles and make sure there is enough data (at least 10 markers). Don't forget to replace the `-` with `:`. For example, we might start tweaking the following panel:
