...
- Students will use this website: <https://prs.byu.edu/calculate_score.html>. Access to Microsoft Excel or Google Sheets may be helpful.
- Toy data hosted at: <https://genomicseducation.org/data/prs_ind_1.txt>
