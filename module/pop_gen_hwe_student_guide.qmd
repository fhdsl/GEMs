...
```{r, fig.align='center', echo = FALSE, fig.alt= "Illustration of pea plant flowers and the alleles that cause color.", out.width = '90%'}
ottrpal::include_slide("https://docs.google.com/presentation/d/10EohJqU8e_A34_WxDvBKAvLnk9wMkrB_b_YRAw-0Q6I/edit?slide=id.g3c7aa53d2fa_0_62#slide=id.g3c7aa53d2fa_0_62")
```
...
```{r, fig.align='center', echo = FALSE, fig.alt= "Illustration of 9 koi fish, with explanation of the allele frequency calculation.", out.width = '90%'}
ottrpal::include_slide("https://docs.google.com/presentation/d/10EohJqU8e_A34_WxDvBKAvLnk9wMkrB_b_YRAw-0Q6I/edit?slide=id.g3c7aa53d2fa_0_0#slide=id.g3c7aa53d2fa_0_0")
```
...
::: callout-tip
# It's all about the genotype frequency!
...
Run the model to 150 generations, recording the allele and genotype frequencies at both 75 and 150 generations. Feel free to speed this up since it’s a simulation! **Make sure to take a screenshot of your Trial 1a fishpond and Data Collection page at 150 generations - you will submit this with your assignment!**

## Trial 1b. Population size = 25 koi

Before running this simulation, change the settings to the following values. **The only parameters that have changed between this and trial 1a at the initial size and the carrying capacity.**
...
You will run chi-square tests on both trials. This can be calculated by hand, or by using either Excel or Google Sheets. Instructions for using Excel or Google Sheets are below.

**Expand this section for instructions on running a chi-square test in Microsoft Excel.**

::: {.callout-caution collapse="true"}
# Using Microsoft Excel for Chi-Square Tests
...
::: {.callout-caution collapse="true"}
# Using Google Sheets for Chi-Square Tests
...
## Trial 2a. Reduced fitness for r allele

In this simulation, any koi who is homozygous for the r allele (rr) is 50% less likely to reproduce compared to koi who carry at least one copy of the R allele (RR and Rr individuals). Carrying two copies of the r allele is disadvantageous! Let's imagine that the fishpond water is very muddy and dark. Red (RR) and red-spotted (Rr) koi blend in better with the dark water, but the white (rr) koi are easier for predators like herons to see and catch.
...
## Trial 2b. Changing the fitness of the r allele
Now you will change the environment so that the r allele becomes advantageous while **using the ending population from trial 2a**. This means you will _not_ press the reload button after changing the simulation settings. The only setting you will change is the genotype fitness!

Genotype fitness is always environment-dependent. Let's imagine the water in the fishpond becomes clearer and predators (like herons) can suddenly see the red (RR) and red-spotted (Rr) koi much more easily than the white (rr) koi. We are modeling this environmental change by changing the genotype fitness values!

**DO NOT PRESS THE RELOAD BUTTON. KEEP USING THE ENDING POPULATION FROM TRIAL 2a.**

- **Genotype Fitness: rr = 1.0, Rr = 0.8, RR = 0.5**

Run the model an additional 150 generations, recording the allele and genotype frequencies at both 225 and 300 generations. Make sure to just unpause the simulation from trial 2a instead of pressing the reload button! **Make sure to take a screenshot of your Trial 2b fishpond and Data Collection page at 300 generations - you will submit this with your assignment!**


## Running a chi-square test

You will run again chi-square tests on both trials. This can be calculated by hand, or by using either Excel or Google Sheets. Instructions for using Excel or Google Sheets are below.
...
- table of allele proportions at generations 75 and 150 (or 225 and 300, for trial 2b) 
...
You will have a total of four Data Collection screenshots, four allele proportion tables, and four chi-square calculations and p-values.
