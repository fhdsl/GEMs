...
Full gene expression data with no comparisons, just counts (*NOTE:* This dataset is only used in the independent project guide): <https://genomicseducation.org/data/mouse_autism_counts.csv>
