...
Even though this dataset is from a single study, there are still lots of options for independent research questions. If you're not sure where to start, let's start broadly and think about the types of questions that are suitable for this data.
...
TODO: Add specific gene suggestions? 
