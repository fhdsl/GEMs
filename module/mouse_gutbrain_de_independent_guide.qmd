...
We will create another new column in our dataset. We will then tell R  In this new column, he genes in our list (Reg3a and Pchdh12) 

```{r}
df$delabel <- ifelse(df$gene_symbol %in% head(df[order(df$padj), "gene_symbol"], 30), df$gene_symbol, NA)
```

You may want to add a title to your plot, or change the axis titles. 
