...
**Duration:** Approximately 1.5 - 2 hours (estimated with community college students) ([help us improve this estimate!](https://forms.gle/pgvLDMChG19pGjCq7))
...
Instructors have mentioned this works well as an **in-class** activity, compared to an independent modality such as assigned homework.

You might have students work in teams with one doing the code and the other following the instructions.
:::
...
An answer key is available [here](https://docs.google.com/document/d/1kPMygksOgVh5n7UUkETU4vX1TCekbQWA/edit?usp=sharing). Please message Ava Hoffman (ahoffma2 at fredhutch dot org) to get access.
...
Students might struggle with the question, "Many individuals are missing diagnoses, genotypes, or both. Why do you think that might be the case?" Encourage them to think critically and consider ethics here!
:::

::: {.callout-note}
## Note

You might also wish to include a discussion of genetic sex versus gender expression. There is growing awareness of the nonbinary nature of sex and gender, as well as respect for the importance in clinical settings of a person's self-identified gender and sexuality  [@Bennett2022]. For example, more inclusive pedigrees might use shapes that align with gender expression, while noting biological sex (such as assigned female at birth, or AFAB) underneath.
:::

## Outline

-   Part 1: Background and Setup (20-25 minutes)

-   Part 2: Basic Pedigree Construction (20-25 minutes)

-   Part 3: Adding Diagnostic Information (15 minutes)
