...
In order to be accurate, PRS scores must be calculated based on variants collected from the same ancestral population as the patient. This is because some alleles are more rare in specific human ancestries and can confer different amount of risk.
