...
Notice the variant information. The most severe **rs7463326** variant lies in an [intron](https://www.genome.gov/genetics-glossary/Intron), or in a part of the gene that doesn't end up in the final protein. 
...
Repeat the steps above, with Mr. B's data: <https://genomicseducation.org/data/prs_ind_2.txt>. Make sure to select both the _Conti_ and _Eeles_ studies.
