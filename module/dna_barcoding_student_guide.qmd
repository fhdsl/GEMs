...
This activity explores forensic uses of DNA barcoding and DNA reference datasets. You will work with data from several real forensic investigations in order to identify the species of a sample based on a small fragment of DNA.
...
What we've been describing in this case file is called  __pharmacovigilance__.
:::
...
Three additional herbal medicines the researchers tested were black cumin seeds and guarana. Following the devil's claw example, use the BOLD website to identify these three samples, then answer the questions below.

*   putative black cumin sample: <https://genomicseducation.org/data/barcoding_black_cumin_rbcL.fasta>
*   putative guarana sample: <https://genomicseducation.org/data/barcoding_guarana_rbcL.fasta>
...
2. According to your BOLD search, what is the species identity of the each sample in the case study you chose? What are the common names of these species?
...
*   putative guarana sample: <https://genomicseducation.org/data/barcoding_guarana_ITS2.fasta>
...
4. According to your Genbank search, what is the species identity of your three samples? What are the common names of these species?

5. What is the percent identity value for the top result of each search?

6. Do the species identities from the Genbank search match the species identities from the BOLD search?

7. Answer the question that matches the case file you chose.
