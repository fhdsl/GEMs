...
Students will benefit from some understanding of the Central Dogma and genetically-based trait expression. They should be aware of mice as a model organism and be comfortable using online genomic databases.

This activity requires plotting.
