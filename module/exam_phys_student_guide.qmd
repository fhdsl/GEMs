...
If everything went correctly, you should see both an object called `phys_data` in the Environment Pane (top right) and the top few rows of the data printed to the console.
